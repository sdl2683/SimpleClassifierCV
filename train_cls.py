...
class LeavesData(Dataset):
    def __init__(self, csv_path, file_path, class2num, num2class, train_transform, valid_transform, mode='train', valid_ratio=0.1, resize_height=340, resize_width=340, cutout_prob=0.4):
        """
        Args:
